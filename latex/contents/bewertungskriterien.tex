...
\label{sec:inhaltliche-kriterien}
    ...
    \begin{itemize}
        ...
        \item \textbf{Qualität des Ergebnisses, Erkenntnisgewinn}: Wie hoch ist die Qualität der Lösung? Erfüllt die Lösung vorher definierte Anforderungen? 
                
    \end{itemize}
Zusätzlich für Bachelor- und Master-Thesis bewerten wir ...
    \begin{itemize}
        \item \textbf{... den eigenen kreativen Anteil}: 
        ...
        \item \textbf{... die Abgrenzung zu verwandten Arbeiten}: Werden verwandte Arbeiten genannt und auch mit der eigenen Arbeit verglichen: Was ist in der eigenen Arbeit anders, neu oder besser als in verwandten Arbeiten?
	    
	    \item \textbf{... das erweiterte Problemverständnis}: Demonstriert der/die Autor/-in ein umfassendes Verständnis des Problembereichs? Sind die genannten Probleme in einen größeren Zusammenhang gesetzt? Werden Verknüpfungen zu anderen Themen hergestellt? Wird ein interessanter Ausblick gegeben, also (\enquote{über den Tellerrand geschaut}) und ...
        
        \item ... wie substantiell ist der {\bf Erkenntnisgewinn} im Sinne der gestellten Forschungsfrage(n)?
...
\section{Äußerliche und formale Kriterien}
    ...
    \begin{itemize}
    	...
    	\item \textbf{Arbeit mit Quellen}: Werden Quellen an passenden Stellen genannt und korrekt zitiert? Wird ggf.\ auf die Nutzung KI-basierter Werkzeuge hingewiesen? 
    \end{itemize}
    
\section{Bewertungskriterien für das Kolloquium}
\label{sec:bewertung-kolloquium}

Bei allen schriftlichen Arbeiten wird zusätzlich zur Ausarbeitung ein Kolloquium abgehalten und bewertet. Bei Praxisprojekten ist es üblich, einen Vortrag mit Vortragsfolien zu halten, mit anschließenden kurzer Diskussion vor der gesamten Studiengruppe. Beim Kolloquium zur Bachelor- oder Master-Thesis findet ein \textit{Prüfungsgespräch} statt, in dem Ihnen die Prüfer Fragen zur Arbeit stellen. In einem Prüfungsgespräch wird die fachliche und methodische Fundierung Ihrer Antworten bewertet und ob Sie Zusammenhänge gut verständlich erklären können. Besprechen Sie mit Ihrem (Erst-)prüfer, in welcher Form er/sie das Kolloquium abhalten möchte.
...
Auf folgende Kriterien achten wir bei der Bewertung des Vortrags:
    ...
    \begin{itemize}
    	...
    	\item \textbf{Fachliche und Methodische Fundierung}: Wird fachliches und methodisches Wissen demonstriert? Werden zum Beispiel  passende fachliche Diagramme für die Beschreibung von Architekturen und Abläufen verwendet und erklärt? Antwortet der/die Vortragende fundiert auf Fragen?
