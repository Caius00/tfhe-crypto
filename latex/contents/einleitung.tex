...
\begin{itemize}
    \item Praxisarbeit (Bachelor Informatik und Wirtschaftsinformatik sowie Master in Advanced Software Engineering)
    \item Bachelor-Thesis (Informatik, Wirtschaftsinformatik)
    \item Master-Thesis (Master in Advanced Software Engineering)
\end{itemize}
...
Zudem ist dieses Dokument mit Hilfe einer \textbf{\LaTeX{}-Vorlage} geschrieben, die wir Ihnen als Vorlage für das Verfassen Ihrer Arbeiten empfehlen. Diese Vorlage erhalten Sie hier:
