...
use tfhe::{generate_keys, prelude::*, CompressedServerKey, ConfigBuilder, FheBool, FheUint32, ClientKey};
...
fn build_app() -> Router {
    ...
    async fn test_auction_successful_flow() {
        ...
        let result_bytes = general_purpose::STANDARD.decode(encrypted_result_b64).unwrap();
